...
class RestApiQuotesRepositories implements QuotesRepository {
  ...
  @override
  Future<Either<Failure, AllQuotes>> getAllQuotes(
    int page,
    String userToken,
  ) async {
    try {
  ...
  @override
  Future<Either<Failure, Quote>> getQuoteDetails(
    int id,
    String userToken,
  ) async {
    try {
  ...
  @override
  Future<Either<Failure, Quote>> addQuoteToFavorite(
    int id,
    String userToken,
  ) async {
    try {
  ...
  @override
  Future<Either<Failure, Quote>> quoteDownVote(int id, String userToken) async {
    try {
      final response = await dio.put(
        'quotes/$id/downvote',
        options: Options(
  ...
  @override
  Future<Either<Failure, Quote>> quoteUpVote(int id, String userToken) async {
    try {
      final response = await dio.put(
        'quotes/$id/upvote',
        options: Options(
  ...
  @override
  Future<Either<Failure, Quote>> removeQuoteFromFavorite(
    int id,
    String userToken,
  ) async {
    try {
  ...
  @override
  Future<Either<Failure, Quote>> clearVoteOnQuote(
    int id,
    String userToken,
  ) async {
    try {
